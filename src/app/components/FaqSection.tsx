...
const defaultFAQ: Record<string, FAQItem[]> = {
  ...
  "/investors": [
  { 
    question: "Какие инвестиции требуются для запуска?", 
    answer: "Нам нужны средства для масштабирования логистики, маркетинга и IT-инфраструктуры." 
  },
  { 
    question: "Какой ROI ожидается?", 
    answer: "Ожидаемый ROI — около 1100% за счёт масштабируемости модели и высокой маржинальности." 
  },
  { 
    question: "В чём уникальность вашего маркетплейса?", 
    answer: "У нас два приложения: B2B для закупки и B2C для продажи. Своя логистика, фотостудия, финтех и внутренняя валюта. Доставка за 1 день по всей Турции." 
  },
  { 
    question: "Какие риски проекта и как вы их снижаете?", 
    answer: "Основные риски — конкуренция и операционные издержки. Мы снижаем их за счёт собственной логистики, прозрачных условий для продавцов и масштабируемой IT-платформы." 
  },
  { 
    question: "Какой рынок вы планируете занять?", 
    answer: "Начинаем с Турции (рынок e-commerce $20B в 2024), затем расширяемся в СНГ с акцентом на быструю доставку и удобство для продавцов." 
  },
  { 
    question: "Какая бизнес-модель?", 
    answer: "Комиссия с продаж 3–20%, дополнительные услуги для продавцов (логистика, контент, реклама), финтех-операции через внутреннюю валюту." 
  },
]
};
